...
const PainelControle = () => {
  // Estado para saber qual monitor está selecionado (padrão: monitor1)
  ...
  const enviarComando = (mensagem, corFundo, acaoType) => {
    ...
    // Estrutura: monitores / monitor1 / status / ...
    set(ref(db, `monitores/${monitorId}/status`), {
      mensagem: mensagem,
      cor: corFundo,
  ...
  return (
    <div style={styles.controleContainer}>
      ...
      {/* SELEÇÃO DE MONITOR (Inspirado na arte móvel) */}
